...
public static class ReportPdfRenderer
{
        ...
        TimeZoneInfo? timeZone = null)
    {
        ...
        // Source lives in the footer (next to "generated by") so the
        // centred header subtitle carries only the reporting window;
        // keeping the source out of the header stops it from skewing
        // the eye's sense of where the page centre / table columns
        // line up.
        ...
        var doc = new NiewebPdfDocument(
            ...
            timeZone: tz,
            footerNote: $"Source: {header.SourceDisplayName}");
